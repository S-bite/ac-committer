...
int main(){
  ...
  cin>>n>>m>>s>>t;
  long long int u[m],v[m],a[m],b[m];
  vector< vector<long long int> > gy (n,vector<long long int>(n,10000000000+1));
  vector< vector<long long int> > gs (n,vector<long long int>(n,10000000000+1));
