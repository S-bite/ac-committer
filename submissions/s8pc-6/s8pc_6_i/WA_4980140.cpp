...
int main(int argc, char const *argv[])
{
    ...
    while (cng)
    {
        ...
        rep(i, h) rep(j, w)
        {
            ...
            if (j + 1 < w && g[i][j + 1].value + g[i][j].value > norma && b[i][j + 1] == true)
            {
            ...
            if (j - 1 >= 0 && g[i][j - 1].value + g[i][j].value > norma && b[i][j - 1] == true)
            {
                connectNode(&g[i][j], &g[i][j - 1]);
                b[i][j] = true;
                cng = true;
            ...
            if (i - 1 >= 0 && g[i - 1][j].value + g[i][j].value > norma && b[i - 1][j] == true)
            {
            ...
            if (i + 1 < h && g[i + 1][j].value + g[i][j].value > norma && b[i + 1][j] == true)
            {
                connectNode(&g[i][j], &g[i + 1][j]);
                b[i][j] = true;
                cng = true;
