...
int main(int argc, char const *argv[])
{
    ...
    rep(i, h) rep(j, w)
    {
        ...
        if (j + 1 < w && g[i][j + 1].value + g[i][j].value > 2 * norma && b[i][j + 1] == true)
        {
        ...
        if (j - 1 >= 0 && g[i][j - 1].value + g[i][j].value > 2 * norma && b[i][j - 1] == true)
        {
            connectNode(&g[i][j], &g[i][j - 1]);
            b[i][j] = true;
        }
        ...
        if (i - 1 >= 0 && g[i - 1][j].value + g[i][j].value > 2 * norma && b[i - 1][j] == true)
        {
        ...
        if (i + 1 < h && g[i + 1][j].value + g[i][j].value > 2 * norma && b[i + 1][j] == true)
        {
            connectNode(&g[i][j], &g[i + 1][j]);
            b[i][j] = true;
        }
    ...
    while (cng)
    {
        ...
        rep(i, h) rep(j, w)
        {
            ...
            //   cerr << "right" << endl;
            if (j + 1 < w && b[i][j + 1] == true && g[i][j].value > 2)
            {
                connectNode(&g[i][j], &g[i][j + 1]);
                b[i][j] = true;
                cng = true;
            ...
            if (j - 1 >= 0 && b[i][j - 1] == true && g[i][j].value > 2)
            {
                connectNode(&g[i][j], &g[i][j - 1]);
                b[i][j] = true;
                cng = true;
            ...
            if (i - 1 >= 0 && b[i - 1][j] == true && g[i][j].value > 2)
            {
                connectNode(&g[i][j], &g[i - 1][j]);
                b[i][j] = true;
                cng = true;
            ...
            if (i + 1 < h && b[i + 1][j] == true && g[i][j].value > 2)
            {
                connectNode(&g[i][j], &g[i + 1][j]);
                b[i][j] = true;
                cng = true;
