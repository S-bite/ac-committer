...
int main(int argc, char const *argv[])
{
    ...
    rep(k, m)
    {
        ...
        int i = bonus[k].a - 1;
        int j = bonus[k].b - 1;
        if (used[ball[i].id] || used[ball[j].id])
            continue;
        ...
        rep(_, 100)
        {
            ...
            ball[j].x = 2 * ball[i].r - mt() % (4 * ball[i].r) + ball[i].x;
            ball[j].y = 2 * ball[i].r - mt() % (4 * ball[i].r) + ball[i].y;
            ball[j].z = 2 * ball[i].r - mt() % (4 * ball[i].r) + ball[i].z;
