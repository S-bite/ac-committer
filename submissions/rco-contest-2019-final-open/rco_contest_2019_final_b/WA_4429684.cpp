...
{
    int ret = 0;
    rep(i, 10) rep(j, 10) if (grid[i][j] == 0) ret++;
    rep(i, 10) rep(j, 10, 20) if (grid[i][j] == 1) ret++;
    rep(i, 10, 20) rep(j, 10) if (grid[i][j] == 2) ret++;
    rep(i, 10, 20) rep(j, 10, 20) if (grid[i][j] == 3) ret++;
    score = ret;
}
